...
<ul>
<li>🛡️ <b>阶段一：启动时验证</b><br><blockquote>UEFI固件验证引导加载器和内核的签名，确保启动过程的初始纯洁性。</blockquote></li>
<li>🏁 <b>阶段二：信任交接</b><br><blockquote>内核成功加载后，安全启动的使命完成。信任链在此刻交接，但传统上并未延续。</blockquote></li>
<li>🚨 <b>阶段三：运行时风险暴露</b><br><blockquote>所有用户空间的应用、库和配置文件都处于无监控状态，为攻击者留下了广阔的攻击面。</blockquote></li>
</ul>
</td>
</tr>
<tr>
...
<blockquote><p align="center">一个安全的系统必须建立在一条信任链之上，其起点是物理上不可更改的硬件信任根。</p></blockquote>
</td>
</tr>
<tr>
<td colspan="4">
...
<tr>
<td width="25%" align="center" valign="top">🕵️<br><b>IMA</b><br><small>运行时哨兵</small><br><blockquote>评估文件<b>内容</b>是否被篡改。</blockquote></td>
<td width="25%" align="center" valign="top">🔗<br><b>EVM</b><br><small>离线防御者</small><br><blockquote>保护文件<b>元数据</b>不被伪造。</blockquote></td>
<td width="25%" align="center" valign="top">🛡️<br><b>TPM 2.0</b><br><small>硬件锚点</small><br><blockquote>提供防篡改的<b>密钥存储</b>与<b>测量日志</b>。</blockquote></td>
<td width="25%" align="center" valign="top">📦<br><b>UKI</b><br><small>原子化启动</small><br><blockquote>将<b>安全策略</b>与内核一同签名。</blockquote></td>
</tr>
<tr>
<td colspan="4">
...
<ol>
<li><b>🚀 启动时: 信任锚定</b><br><blockquote>TPM检查PCR7值，确认安全启动状态后，解封EVM密钥。</blockquote></li>
<li><b>🔑 第1步: EVM验证元数据</b><br><blockquote>内核使用解封的密钥，验证EVM签名，确保IMA哈希可信。</blockquote></li>
<li><b>🕵️ 第2步: IMA评估文件内容</b><br><blockquote>内核计算文件实时哈希，并与可信的IMA哈希对比。</blockquote></li>
</ol>
